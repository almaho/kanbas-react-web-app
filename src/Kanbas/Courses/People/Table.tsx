      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-03-15</td>
            <td className="wd-total-activity">05:15:48</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2022-07-22</td>
          ...
          <tr>
            ...
            <td className="wd-total-activity">08:30:15</td>
          </tr>
        </tbody>
      </table>
    </div>
